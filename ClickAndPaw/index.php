...
// Obtener las 3 últimas mascotas disponibles para la sección de destacadas
try {
    ...
    // Manejar el error de forma silenciosa para que la página no se rompa
    $mascotas_destacadas = [];
...
<!-- ... (Tu sección .hero y .mission-section se quedan igual) ... -->
<!-- ==========================================================================
...
<!-- ==========================================================================
   SECCIÓN DE MASCOTAS DESTACADAS (AHORA DINÁMICA)
   ========================================================================== -->
                ...
                <?php foreach ($mascotas_destacadas as $mascota): ?>
                    <div class="pet-card">
                        ...
                        <div class="pet-info">
                            ...
                            <!-- El enlace apunta al formulario de adopción con el ID correcto -->
