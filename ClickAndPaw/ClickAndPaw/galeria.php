...
// Definir variables para la plantilla del header
$page_title = 'Galería de Mascotas - Click & Paw';
$active_page = 'galeria';

// Obtener filtros de la URL de forma segura
$filtro_especie = $_GET['especie'] ?? '';
$filtro_tamano = $_GET['tamano'] ?? '';
$filtro_genero = $_GET['genero'] ?? '';
$busqueda = isset($_GET['buscar']) ? trim($_GET['buscar']) : '';

// Arreglos para construir la consulta SQL de forma segura
$sql_parts = [];
$params = [];

// Parte base de la consulta: solo mascotas disponibles
...
// Unir las partes de la consulta si hay filtros
if (!empty($sql_parts)) {
...
// Función para obtener un emoji representativo
                    ...
                    <div class="pet-card">
                        <div class="pet-image">
                            <?php if (!empty($mascota['foto'])): ?>
                                <!-- La ruta ahora apunta a la carpeta uploads -->
                        ...
                        <div class="pet-info">
                            ...
                            <!-- El enlace debe apuntar al formulario de adopción -->
