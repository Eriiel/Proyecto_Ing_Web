...
try {
    // Obtenemos todas las mascotas, sin importar su estado, para el panel de admin
...
<head>
    ...
    <!-- Asegúrate de que la ruta al CSS es la correcta -->
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($m['foto']) && file_exists('../uploads/' . $m['foto'])): ?>
                                    ...
                                    <img src="../uploads/<?= htmlspecialchars($m['foto']) ?>" alt="Imagen de <?= htmlspecialchars($m['nombre']) ?>" class="table-pet-image">
                                <?php else: ?>
                                    <!-- Si no hay imagen, muestra un texto amigable -->
                            ...
                            <td class="actions">
                                ...
                                <a href="eliminar_mascota.php?id=<?= $m['id'] ?>" class="btn btn-delete" onclick="return confirm('¿Seguro que deseas eliminar a <?= htmlspecialchars($m['nombre']) ?>?')">Eliminar</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
